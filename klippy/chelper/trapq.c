             ...
             , double start_v, double cruise_v, double accel)
{
    ...
    struct coord backlash_axes = { .x=backlash_axes_x, .y=backlash_axes_y, .z=backlash_axes_z };
    if (accel_t) {
        ...
        m->axes_r = axes_r;
        m->backlash_axes = backlash_axes;
        trapq_add_move(tq, m);
        
        //infof("\tadd accel move");
